...
SECRET_KEY = 'django-insecure-gdbaxh#_%e%$3xk&+42^0236u8_q79f!%*hk)*o)i8ksr86wym'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'),
                 os.path.join(BASE_DIR, 'product_management', 'templates', 'product_management'),  # Add global templates directory
